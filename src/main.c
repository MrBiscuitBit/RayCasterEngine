...
int main(int argc, char *argv[]){
    ...
    while(running == 1){
        ...
        rc_render_wall_projection(ray_caster);
        rc_render_sprite_projection(ray_caster);
        rc_render_map_tiles(ray_caster->board, map_scale_factor);
        //rc_render_map_rays(ray_caster, map_scale_factor);
        rc_render_map_player(ray_caster->player, map_scale_factor);
        rc_render_map_sprites(ray_caster->sprites, map_scale_factor);
